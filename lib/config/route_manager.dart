...
class RouteManager {
  ...
  static void navigateAndReplace(String routeName, {Map<String, dynamic>? arguments}) {
    _routeData[routeName] = arguments ?? {};
    // This will be implemented with actual Flutter navigation later
    print('Navigate and replace to: $routeName with arguments: $arguments');
  }
  
  static void navigateAndClearStack(String routeName, {Map<String, dynamic>? arguments}) {
    _routeData[routeName] = arguments ?? {};
    // This will be implemented with actual Flutter navigation later
